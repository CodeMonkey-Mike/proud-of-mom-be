const processEnv = () => {
  ...
  process.env.GCL_STORAGE_PATH =
    env.GCL_STORAGE_PATH || "rock-fountain-288922-9b7e8d07849d.json";
  ...
  process.env.TYPEORM_USERNAME = env.TYPEORM_USERNAME || "";
  process.env.TYPEORM_PASSWORD = env.TYPEORM_PASSWORD || "";
  process.env.TYPEORM_DATABASE = env.TYPEORM_DATABASE || "";
};
