...
export class CreateCountry1587548264941 implements MigrationInterface {

    private static readonly table = new Table({
        name: 'country',
        columns: [
          ...MigrationUtil.getIDColumn(),
          MigrationUtil.getVarCharColumn({ name: 'code', isUnique: true }),
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.createTable(CreateCountry1587548264941.table);
      await queryRunner
      .manager
      .createQueryBuilder()
      .insert()
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
      await queryRunner.dropTable(CreateCountry1587548264941.table);
    }
